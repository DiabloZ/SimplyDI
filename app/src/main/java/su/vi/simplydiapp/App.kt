	...
	override fun onCreate() {
		...
		/*	SimplyDIContainer.instance.initializeAndroid(context = this, simplyLogLevel = SimplyLogLevel.FULL)
			...
			*/
			...
			initializeSimplyDIContainer(scopeName = "6", isSearchInScope = false, simplyLogLevel = SimplyLogLevel.FULL){}
			initializeSimplyDIContainer(scopeName = "5", isSearchInScope = true){}
			initializeSimplyDIContainer(scopeName = "4", isSearchInScope = false, simplyLogLevel = SimplyLogLevel.FULL){}
			...
			initializeSimplyDIContainer(scopeName = "12345", isSearchInScope = true, simplyLogLevel = SimplyLogLevel.FULL){
